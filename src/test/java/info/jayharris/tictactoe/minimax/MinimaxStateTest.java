...
class MinimaxStateTest {
    ...
    class Utility {
        ...
        void gameNotOver() {
            ...
            assertThat((LongPredicate) new MinimaxState(board, Piece.O).utility()).isNull();
        }
        ...
        void gameOverNoWinner() {
            ...
            assertThat((LongPredicate) new MinimaxState(board, Piece.O).utility()).isEqualTo(0L);
        }

        @Test
        @DisplayName("game we won")
        void gameOverWeWon() {
            Board board = BoardCreator.create(new Piece[][] {
                    new Piece[] { Piece.X,    null, Piece.X },
                    new Piece[] {    null, Piece.X, Piece.O },
            ...
            assertThat((LongPredicate) new MinimaxState(board, Piece.O).utility()).isEqualTo(Long.MAX_VALUE);
        }

        @Test
        @DisplayName("game we lost")
        void gameOverWeLost() {
            Board board = BoardCreator.create(new Piece[][] {
                    new Piece[] { Piece.X,    null, Piece.X },
                    new Piece[] {    null, Piece.X, Piece.O },
            ...
            assertThat((LongPredicate) new MinimaxState(board, Piece.O).utility()).isEqualTo(Long.MIN_VALUE);
        }
    }
}